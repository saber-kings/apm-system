package cn.saberking.jvav.apm.web.utils.file;
...
import cn.saberking.jvav.apm.web.utils.uuid.IdUtils;
...
public class FileUploadUtils {
    ...
    public static String upload(String baseDir, MultipartFile file, String[] allowedExtension)
        ...
        if (fileNameLength > FileUploadUtils.DEFAULT_FILE_NAME_LENGTH) {
            throw new BusinessException(BaseResponseCode.FILE_NAME_LENGTH_LIMIT_EXCEEDED);
        }
    ...
    public static void assertAllowed(MultipartFile file, String[] allowedExtension)
        ...
        if (size > DEFAULT_MAX_SIZE) {
            throw new BusinessException(BaseResponseCode.UPLOAD_FILE_TOO_LARGE);
        }
